...
EssentialsSection:NewButton("Anti-Mod", "Makes your game doodoo but with Improved Performance.", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/vxnnf9Zk"))()
end)

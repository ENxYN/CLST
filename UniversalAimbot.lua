...
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Remade by CLST Enterprise", Text = "Welcome!"})

local DeleteMob ={
    GUi = {
        OpenNCloseButton = false; -- Have A Button For It
        KeybindEnable = true; -- If You Want A Bind For The Menu
        Keybind = "p"; -- Menu Key Bind
    };
	Aimbot= {
...
local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border" game:GetService("StarterGui"):SetCore("SendNotification", {Title = "#CLST", Text = "Pakyu Tangina Ka"})
